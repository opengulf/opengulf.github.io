...
<figcaption>Figure 1. This table shows common Named Entities and their types. Source: [NLTK Textbook](https://www.nltk.org/book).<figcaption>
...
<figcaption>Figure 2. A sample Information Extraction Architecture pipeline. Source: [NLTK Textbook](https://www.nltk.org/book).<figcaption>
...
</figcaption>Figure 8. Segmentation and Labeling at both the Token and Chunk levels. Source:[NLTK textbook](https://www.nltk.org/book/).</figcaption>
